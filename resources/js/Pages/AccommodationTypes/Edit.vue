...
const form = useForm({
    property_id: props.accommodationType.property_id,
    name: props.accommodationType.name,
    description: props.accommodationType.description,
    capacity_adults: props.accommodationType.capacity_adults,
    capacity_children: props.accommodationType.capacity_children,
    size_m2: props.accommodationType.size_m2,
    base_price: props.accommodationType.base_price,
    checkin_time: props.accommodationType.checkin_time || '14:00',
    checkout_time: props.accommodationType.checkout_time || '11:00',
});

const submit = () => {
    form.put(route('accommodation-types.update', props.accommodationType.id), {
        onFinish: () => {},
    });
};
</script>
...
<template>
    <Head title="Editar Tipo de Acomodação" />

    <AppLayout title="Editar Tipo de Acomodação">
